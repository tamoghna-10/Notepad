          ...
          <div
            ...
            >
              ...
              >
                ...
                <label
                    htmlFor="chk"
                    className={`text-white ${isChecked ? "scale" : ""}`} // Apply the "scale" class conditionally
                    style={{
                      fontSize: "2.3em",
                      display: "flex",
                      margin: "60px",
              ...
              style={{ 
                ...
                <label
                    htmlFor="chk"
                    className={`text-primary ${isChecked ? "scale" : ""}`} // Apply the "scale" class conditionally
                    style={{
                      fontSize: "2.3em",
                      display: "flex",
                      margin: "60px",
                      ...
                      transform: isChecked ? "scale(1)" : "scale(.6)" , // Apply the transform scale
                    }}>
                    Login
                  </label>
                  <div className="form-group">
